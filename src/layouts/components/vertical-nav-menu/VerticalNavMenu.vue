...
<!--            <span class="vx-logo-text text-primary" v-show="isMouseEnter || !reduce" v-if="title">Admin</span>-->
            <div style="margin-left: 3px;" class="text-right leading-tight hidden sm:block">
  ...
  computed: {
    ...
    authUser () {
      ...
      if (authUser) {
        ...
        return {full_name: 'Unauthorized', email: 'none'}
      }
    },
  },
  watch: {
